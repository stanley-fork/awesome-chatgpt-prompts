...
Loop engineering is the practice of designing the feedback cycle around an AI system: the goal, actions, observations, evaluation, state, guardrails, and stopping rules that move work toward a verifiable result.
</Callout>
  ...
  scenarios: [
    {
      ...
      goal: "Correct checkout totals without changing valid discount behavior.",
      stopRule: "Targeted regression passes, full checkout suite passes, and lint is clean—or stop after three attempts and escalate.",
      evidence: "Reproduction steps, test output, the code diff, and the final regression suite.",
      cycles: [
        {
          action: "Reproduce the reported total and add a failing test for tax plus percentage discount.",
          observation: "The test fails by one cent only when tax is rounded before the discount is applied.",
          evaluation: "The bug is reproduced with a deterministic signal, but its source is not fixed yet.",
        ...
        },
        {
          ...
          observation: "The regression passes, but one coupon integration test now fails on a fixed-amount discount.",
        ...
        {
          action: "Apply the narrow calculation fix, then run the regression, full checkout suite, and lint.",
    ...
    },
    {
      ...
      stopRule: "Reach a calibrated conclusion supported by at least three credible sources, with disagreements and limitations stated.",
      ...
      cycles: [
        ...
        },
        {
          ...
          evaluation: "The word 'always' is contradicted. A conditional conclusion is becoming defensible.",
    ...
    },
    {
      ...
      stopRule: "Pass the voice rubric, stay under 140 words, contain one clear call to action, and survive a factual review.",
      ...
      cycles: [
        ...
        {
          action: "Rewrite the opening and compress the body to one problem-benefit-proof sequence.",
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The original failure is reproduced, then the regression and full suite pass.</td>
    </tr>
    <tr>
      <td>Research</td>
...
<TryIt
  ...
  description="Replace the variables with a recurring task from your own work. Ask the AI to challenge weak evidence and ambiguous stopping rules."
